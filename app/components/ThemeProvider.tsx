...
export const THEMES: ThemeDef[] = [
  {
    ...
    vars: {
      ...
      "--danger": "#ff4d6d", "--warn": "#ffb347", "--text": "#e2e8f0", "--muted": "#8b95a7",
      "--color-text-muted": "#828c9e", "--color-border-primary": "#3a4060", "--on-accent": "#081020",
      "color-scheme": "dark",
    },
  },
  {
    ...
    vars: {
      ...
      "--danger": "#dc2626", "--warn": "#d97706", "--text": "#0f172a", "--muted": "#596274",
      "--color-text-muted": "#5b6575", "--color-border-primary": "#cbd5e1", "--on-accent": "#081020",
      "color-scheme": "light",
    },
  },
  {
    ...
    vars: {
      ...
      "--danger": "#ef4444", "--warn": "#f59e0b", "--text": "#f1f5f9", "--muted": "#8b8f99",
      "--color-text-muted": "#808591", "--color-border-primary": "#292929", "--on-accent": "#ffffff",
      "color-scheme": "dark",
    },
  },
  {
    ...
    vars: {
      ...
      "--danger": "#f87171", "--warn": "#fbbf24", "--text": "#e0f0ff", "--muted": "#7ba0bd",
      "--color-text-muted": "#6f92ad", "--color-border-primary": "#1e3a5f", "--on-accent": "#051020",
      "color-scheme": "dark",
    },
  },
  {
    ...
    vars: {
      ...
      "--danger": "#f87171", "--warn": "#fbbf24", "--text": "#d4d4d4", "--muted": "#9a9a9a",
      "--color-text-muted": "#8f8f8f", "--color-border-primary": "#383838", "--on-accent": "#111111",
      "color-scheme": "dark",
    },
  },
]
