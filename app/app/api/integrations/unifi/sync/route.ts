...
import { unifiLogin, unifiGetSites, unifiGetDevices, unifiLogout, unifiDeviceType } from "@/lib/unifi"
      ...
      try {
        ...
        for (const d of devices) {
          try {
            ...
            const uptime = typeof d.uptime === "number" ? d.uptime : null
            const connectedClients = typeof d.num_sta === "number" ? d.num_sta : null
            ...
            // Try upsert by externalId first, then fall back to MAC
