...
const DEFAULT_TYPES: { name: string; sortOrder: number; template: TemplateDefinition }[] = [
  ...
  },
  {
    ...
    sortOrder: 160,
    template: {
      standardFields: ["friendlyName", "make", "model", "serial", "managementUrl", "firmwareVersion", "room", "notes", "purchaseDate", "warrantyExpiry"],
      customFieldDefs: [
        { key: "runtimeMinutes", label: "Runtime (min)", type: "number", required: false },
        { key: "va", label: "VA Rating", type: "text", required: false },
        { key: "batteryExpiry", label: "Battery Expiry", type: "date", required: false },
      ],
    },
  },
  {
