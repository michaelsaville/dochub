...
export default function AuditLogPage() {
  const [tab, setTab] = useState<"field" | "activity">("field")
  ...
  // reload from page 0 whenever the tab changes
  useEffect(() => {
    load(0)
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [tab])
      ...
      <div style={{ padding: "32px", maxWidth: "1200px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", marginBottom: "20px" }}>
          {(["field", "activity"] as const).map((t) => (
            ...
            >
              {t === "field" ? "Field history & reveals" : "Activity events"}
            </button>
          ))}
        </div>
